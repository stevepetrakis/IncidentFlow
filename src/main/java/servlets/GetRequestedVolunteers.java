 ...
 * @author stavr
 */
@WebServlet(name="GetRequestedVolunteers", urlPatterns={"/GetRequestedVolunteers"})
public class GetRequestedVolunteers extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GetRequestedVolunteers</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetRequestedVolunteers at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()){
            ...
            String query = "SELECT firstname, lastname, username, password, email, birthdate, gender, afm, country, volunteer_type, prefecture, municipality, address, job, telephone, lat, lon, height, weight FROM volunteers WHERE username = ?";
            ...
            if(rs.next()){
                ...
                jsonResponse.put("message", "Volunteer not found.");
            }
